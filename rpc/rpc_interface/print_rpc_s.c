...
extern const MIDL_SERVER_INFO AutomationPlugin_ServerInfo;

extern const RPC_DISPATCH_TABLE AutomationPlugin_v1_0_DispatchTable;

static const RPC_SERVER_INTERFACE AutomationPlugin___RpcServerInterface =
    {
    sizeof(RPC_SERVER_INTERFACE),
    {{0x774F83DA,0xB722,0x4E40,{0xB5,0xC0,0xEF,0x8E,0xAD,0x4B,0x2E,0x76}},{1,0}},
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    (RPC_DISPATCH_TABLE*)&AutomationPlugin_v1_0_DispatchTable,
    0,
    0,
    0,
    &AutomationPlugin_ServerInfo,
    0x04000000
    };
RPC_IF_HANDLE AutomationPlugin_v1_0_s_ifspec = (RPC_IF_HANDLE)& AutomationPlugin___RpcServerInterface;
...
static const MIDL_STUB_DESC AutomationPlugin_StubDesc = 
    {
    (void *)& AutomationPlugin___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    RundownRoutines,
...
static const RPC_DISPATCH_FUNCTION AutomationPlugin_table[] =
    {
    NdrServerCall2,
    NdrServerCall2,
    NdrServerCall2,
...
static const RPC_DISPATCH_TABLE AutomationPlugin_v1_0_DispatchTable = 
    {
    3,
    (RPC_DISPATCH_FUNCTION*)AutomationPlugin_table
    };

static const SERVER_ROUTINE AutomationPlugin_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)Open,
    (SERVER_ROUTINE)Print_RPC,
    (SERVER_ROUTINE)Close
    };

static const MIDL_SERVER_INFO AutomationPlugin_ServerInfo = 
    {
    &AutomationPlugin_StubDesc,
    AutomationPlugin_ServerRoutineTable,
    print_rpc__MIDL_ProcFormatString.Format,
    AutomationPlugin_FormatStringOffsetTable,
    0,
    0,
    0,
    0};
